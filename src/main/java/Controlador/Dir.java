...
public class Dir extends javax.swing.JFrame {
    ...
    public static final String path = "C://SISTEMA";
    public static final String PathordenesPendientes = "C://SISTEMA//ORDENES PENDIENTES";
    public static final String PathGuardarOrdenes = "C://SISTEMA//ORDENES";
    public static final String PathAgregarElementoOrdenesPendientes = "C://SISTEMAS//ORDENES PENDIENTES//";
    ...
    public static Dir getInstance(){
        if(instance == null) return new Dir();
